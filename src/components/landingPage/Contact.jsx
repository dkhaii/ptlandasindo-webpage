...
const Contact = () => {
  return (
    <section id="contact" className="flex w-full h-[300px]">
      ...
      <div
        className="absolute xl:px-60 lg:px-40 sm:px-16 px-5
 flex flex-col lg:flex-row w-full py-10 lg:py-20"
      >
        ...
        <div className="flex justify-center lg:justify-end lg:items-center w-full">
