...
const HeadingProduct = () => {
  return (
    <section id="heading-product" className="sm:px-40 px-16 flex flex-col w-full">
        ...
        <div className="flex flex-row pt-10 justify-between items-center w-full">
          <div className="w-full">
            <h1 className="flex-1 font-poppins font-semibold text-[45px] sm:text-[65px] text-secondary leading-[55px] sm:leading-[80px]">
              We come up with high quality products and good service <span className="text-accent text-7xl">.</span>
            </h1>
