  ...
  return (
    <section id="product" className="xl:px-60 lg:px-40 sm:px-16 px-5 bg-white pt-28 lg:flex lg:flex-col w-full">
      <div className="flex items-center flex-col">
        <div className="flex justify-center bg-natural px-3 py-2 rounded-lg text-[12px] lg:text-sm font-bold" data-aos="fade-up" data-aos-duration="1000">OUR PRODUCT</div>
        <div className="lg:mt-2">
          <h1 className="text-[40px] lg:text-4xl font-semibold" data-aos="fade-up" data-aos-duration="1000">Products We Sell</h1>
        </div>
