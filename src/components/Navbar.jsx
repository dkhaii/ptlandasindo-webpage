...
const Navbar = ({ classes }) => {
  ...
  return (
    <nav className={color ? `${classes.transition} bg-white shadow-lg fixed left-0 xl:px-60 md:px-40 sm:px-16 px-5 w-full py-8 flex justify-between items-center z-20` : `fixed ${classes.bg} left-0 xl:px-60 md:px-40 sm:px-16 px-5 w-full py-8 flex justify-between items-center z-20`}>
